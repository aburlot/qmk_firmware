...
enum layer_codes {_LAYER0, _LAYER1, _LAYER2, _LAYER3};

// Alignement avec my/align-commaB
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
  {
    [_LAYER0] = LAYOUT_ortho_4x12
    (
     ...
     KC_HYPR, KC_LCTL, KC_LGUI, KC_LALT, L1_COMA, KC_SPACE, KC_RALT, L2_DOT,   KC_LEFT,  KC_DOWN, KC_UP,    KC_RIGHT
     ),
    ...
    (
     ...
     KC_LSFT, KC_CIRC,  KC_EXCLAIM,   KC_SLASH, KC_EQUAL,    KC_LCBR,     KC_RCBR,     KC_DOLLAR,  KC_BSLASH, KC_PIPE, KC_NO,   KC_NO,
     KC_HYPR, KC_LCTL,  KC_LGUI,      KC_LALT,  L1_COMA,     KC_SPACE,    KC_RALT,     L2_DOT,     KC_LEFT,   KC_DOWN, KC_UP,   KC_RIGHT
     ),
    ...
    (
     ...
     KC_HYPR, KC_LCTL, KC_LGUI, KC_LALT, L1_COMA, KC_SPACE, KC_LSFT,   KC_NO, KC_LEFT, KC_DOWN, KC_UP,  KC_RIGHT
     ),
    ...
    (
     ...
     KC_NO,   KC_NO,   KC_NO,    KC_NO, KC_NO, KC_VOLU, KC_VOLD, KC_NO, KC_NO, KC_MUTE, KC_NO,   KC_NO,
