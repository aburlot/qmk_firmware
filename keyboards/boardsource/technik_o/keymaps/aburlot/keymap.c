...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
  {
    ...
    (
     ...
     L3_SLSH, KC_HYPR, KC_LGUI, KC_LALT, L1_COMA, KC_SPACE, KC_RALT, L2_DOT,   KC_LEFT,  KC_DOWN, KC_UP,    KC_RIGHT
     ),
    ...
    (
     ...
     KC_NO, RGB_MOD, RGB_RMOD, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO
     )
  };
